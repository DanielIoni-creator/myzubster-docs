...
## 📌 Overview
- **Location:** Sant'Aquilina, near Pope John Community
- **Contact:** Don Evio
- **Vision:** Permaculture + Training + Coexistence
- **Budget Goal:** €40,000
...
|-------|----------|------------|
| Phase 1 | Months 1-3 | Launch, setup, basic equipment |
| Phase 2 | Months 4-6 | Permaculture, irrigation, planting |
| Phase 3 | Months 7-12 | Training, coexistence, workshops |
| Phase 4 | Year 2 | Growth, expansion, partnerships |
...
- **Work:** Futura Ambiente (€1,200/month)
- **Status:** Searching for affordable housing in Rimini
